...
- `OPENAI_MODEL`: The OpenAI model to use for classification. Results in the repo produced with model "gpt-4o-mini".
...
- `ANTHROPIC_MODEL`: The Anthropic model to use for classification. Results in the repo produced with model "claude-3-haiku-20240307".
